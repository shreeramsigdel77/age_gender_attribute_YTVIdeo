...
writer = SummaryWriter("./log_output/peta_train_2")
...
def trainer(epoch, model, train_loader, valid_loader, criterion, optimizer, lr_scheduler,
    ...
    for i in range(epoch):
        ...
        checkpoint_dir = "/home/nabusri/BackupFiles/workspace/pedestrian_attribute_recog/resnet50_custom_pedestrian/exp_result/PETA/PETA1/cust_save_model"
        ...
        if cur_metric > maximum:
            ...
            #custom saveing of model
            checkpoint = {
            'epoch': i,
            'state_dict': model.state_dict(),
            'optimizer': optimizer.state_dict()
        }
        cust_save_ckp(checkpoint, checkpoint_dir,i)
